 ...
 * @author Todd Veldhuizen; marginale Komplettierung von M.Boeing
 */
...
/**
 * Diese Funktion fehlte merkwuerdigerweise - habe sie hinzugefuegt. M.Boeing.
 * @param edgeId
 * @param attribute
 * @param value
 * @return
...
{
  try {
    Object[] params = new Object[]{new Integer(edgeId), attribute,
      value };
